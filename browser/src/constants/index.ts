...
export const ProxyMetadataPath = 'configs/proxy/';
export const ProfileMetadataPath = 'configs/profile/';
...
export const DefaultUserAgent = () =>
  `Mozilla/5.${(Math.random() * 3) | 0} (X11; Linux x86_64) AppleWebKit/${(537 + Math.random() * 10) | 0}.36 (KHTML, like Gecko) Chrome/${(91 - Math.random() * 4) | 0}.${(Math.random() * 4) | 0}.${(4472 - Math.random() * 100) | 0}.${(124 + Math.random() * 40) | 0} Safari/${(537 - Math.random() * 20) | 0}.${36 + Math.random() * 30}`;
...
export function GetInitJS(): string {
  ...
  throw new Error(
    `page_script.js not found in either ${scriptPath} or ${sourcePath}`,
  );
}
